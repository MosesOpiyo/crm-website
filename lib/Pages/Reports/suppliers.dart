...
class Suppliers extends StatefulWidget {
  static const String route = '/DashBoard/Reports/Suppliers';
  const Suppliers({super.key});

  @override
  State<Suppliers> createState() => _ReportsState();
}

class _ReportsState extends State<Suppliers> {
  @override
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        TextButton(
                          onPressed: () {
                            Navigator.pushNamed(context, Clients.route);
                          },
